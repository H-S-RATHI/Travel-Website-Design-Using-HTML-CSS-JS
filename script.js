...
function addActiveLink(){
  ...
  section.forEach((section) => {
    ...
    if(scrollY > sectionTop && scrollY <= sectionTop + sectionHeight){
      document
          .querySelector("nav__llink[href*=  " + sectionId + "]")
          .classList.add("nav__llink--active");
    }else{
      document
          .querySelector("nav__llink[href*=  " + sectionId + "]")
          .classList.remove("nav__llink--active");
    }
...
sr.reveal(".home__content,.how__item,.explore__item,.reservation__item,.blog__item,.testimonial__item,.footer__item",{interval:100});
